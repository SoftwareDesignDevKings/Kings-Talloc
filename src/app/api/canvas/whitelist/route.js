    ...
    return Response.json(
        snapshot.docs.map((doc) => {
            ...
            return {
                ...
                term_id: courseData.termId ?? doc.data().termId ?? null,
                term_name: courseData.termName ?? doc.data().termName ?? '',
                term_start_at: courseData.termStartAt ?? doc.data().termStartAt ?? null,
                term_end_at: courseData.termEndAt ?? doc.data().termEndAt ?? null,
...
export async function POST(req) {
    ...
    const data = {
        ...
        termId: body.term_id ?? body.termId ?? null,
        termName: body.term_name || body.termName || '',
        termStartAt: body.term_start_at || body.termStartAt || null,
        termEndAt: body.term_end_at || body.termEndAt || null,
