...
import {
  ...
  FiAlertCircle, FiTrendingUp, FiBookOpen, FiActivity, FiChevronDown
...
const TeacherStats = ({ data, onUpdate }) => {
  ...
  return (
    <>
      ...
      <div className="col-12 col-md-4 col-lg-3">
        <div className="card border-0 shadow-sm position-relative" style={{ cursor: 'pointer' }}>
          <div
            className="card-body"
          ...
          >
            <div className="d-flex align-items-center">
              ...
              <div className="flex-grow-1 ms-3">
                ...
                <h3 className="mb-0 fw-bold">{data.unapprovedStudentRequests || 0}</h3>
              </div>
