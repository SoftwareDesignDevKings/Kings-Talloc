...
const EventDetailsModal = ({ event, onClose, userEmail, userRole, events, setEvents }) => {
    ...
    const [response, setResponse] = useState(
        studentResponse ? (studentResponse.response ? 'accepted' : 'declined') : '',
    );
    ...
    return (
        <div
            ref={offcanvasRef}
            className="offcanvas offcanvas-end tw-w-[480px] tw-max-w-[90vw]"
            tabIndex="-1"
            id="eventDetailsOffcanvas"
        ...
        >
            ...
            <div className="offcanvas-body p-3 d-flex flex-column">
                ...
                {(event.createdByStudent || event.isStudentRequest) &&
                    (event.subject || event.preference) && (
                        <div className="card mb-3 border-0 shadow-sm">
                            <div className="card-header bg-secondary text-white py-2">
                                <h6 className="mb-0 d-flex align-items-center gap-2">
