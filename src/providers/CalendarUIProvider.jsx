...
import { filterEvents, filterAvailabilities } from '@/utils/calendarHelpers';
...
export const CalendarUIProvider = ({ children }) => {
	...
	const filteredEvents = useMemo(() => {
		return filterEvents(allEvents, { userRole, userEmail, filters });
	}, [allEvents, userRole, userEmail, filters]);

	const filteredAvailabilities = useMemo(() => {
		return filterAvailabilities(splitAvailabilitiesData, { userRole, filters });
