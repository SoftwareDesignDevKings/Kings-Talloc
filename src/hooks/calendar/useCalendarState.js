...
export const useCalendarUI = (filterState) => {
  ...
  return {
    ...
    rawSetShowEvents: setShowEvents, // Expose raw setter for filterState
    setShowInitials,
...
export const useCalendarFilterState = (uiState) => {
  ...
  const [selectedAvailabilityWorkType, setSelectedAvailabilityWorkType] = useState(null); // 'tutoring', 'work', 'tutoringOrWork', or null for all
